...
You get started with Run transform plugin by building directly from the latest source code::
   ...
   git clone https://github.com/hydrator/tokenizer-analytics.git
   cd tokenizer-analytics
   mvn clean package
...
You can deploy a plugin using the CDAP CLI::
  ...
  > load artifact target/tokenizer-plugin-<version>.jar \
         config-file target/tokenizer-plugin-<version>.json
